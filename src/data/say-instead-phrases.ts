...
export type PhraseCategory = 'Dismissed' | 'Communication' | 'Defensive' | 'Self-centeredness' | 
  'Resentment' | 'Frustration' | 'Dismissive' | 'Emotionally Invalidating' | 'Tone' | 
  'Expectations' | 'Logistics' | 'Triggering' | 'Comparison' | 'Family Conflict' | 
  'Miscommunication' | 'Defensiveness' | 'Emotional Neglect' | 'Hurt' | 'Insecurity' | 
  'Emotional Tension' | 'Misreading' | 'Threats' | 'Shutdown' | 'Overwhelm' | 
  'Emotional Invalidation' | 'Conflict Escalation' | 'Emotional Distance' | 
  'Gaslighting' | 'Confusion' | 'Emotional Dysregulation' | 'Effort Imbalance' | 
  'Disconnection' | 'Exhaustion' | 'Emotional Safety' | 'Avoidance' | 
  'Emotional Wounding' | 'Vulnerability' | 'Emotional Misalignment' | 
  'Communication Breakdown' | 'Emotional Rigidity' | 'Physical Connection' | 
  'Rejection' | 'Intimacy Issues' | 'Power Struggles' | 'Autonomy' | 'Boundaries' | 
  'Identity Loss';
...
export const sayInsteadPhrases: SayInsteadPhrase[] = [
  ...
  },
  {
    ...
    categories: ['Dismissive', 'Emotionally Invalidating', 'Tone'],
    alternatives: [
  ...
  },
  {
    ...
    categories: ['Threats', 'Shutdown', 'Overwhelm'],
    alternatives: [
  ...
  },
  {
    ...
    categories: ['Emotional Invalidation', 'Dismissiveness'],
    alternatives: [
  ...
  },
  {
    ...
    categories: ['Emotional Minimization', 'Conflict Escalation', 'Tone'],
    alternatives: [
  ...
  },
  {
    ...
    categories: ['Gaslighting', 'Confusion', 'Emotional Dysregulation'],
    alternatives: [
  ...
  },
  {
    ...
    categories: ['Power Struggles', 'Autonomy', 'Boundaries'],
    alternatives: [
  ...
  },
  {
    ...
    categories: ['Dismissiveness', 'Tone', 'Minimization'],
    alternatives: [
  ...
  },
  {
    ...
    categories: ['Abandonment Fear', 'Assumptions', 'Emotional Threat'],
    alternatives: [
  ...
  },
  {
    ...
    categories: ['Control', 'Resentment', 'Power Dynamics'],
    alternatives: [
