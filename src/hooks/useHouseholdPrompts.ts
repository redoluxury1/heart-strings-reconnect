...
import { SubcategoryData } from '@/data/household-duties-subcategories';
...
export const useHouseholdPrompts = (subcategoryId: string, subcategory: SubcategoryData | undefined) => {
