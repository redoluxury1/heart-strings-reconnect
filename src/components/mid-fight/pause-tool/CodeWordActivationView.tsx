  ...
  return (
    <div className="max-w-md mx-auto">
      <div className="text-center mb-8">
        <h3 className="text-xl font-medium text-[#07183D] mb-2">
          Set your pause code word
        </h3>
        <p className="text-sm text-[#07183D]/70 mb-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <label htmlFor="codeWord" className="block text-sm font-medium text-[#07183D] mb-2">
            Your Code Word
          </label>
          <Input
            id="codeWord"
            ...
            className="w-full border-[#07183D]/20 focus:border-[#07183D] focus:ring-1 focus:ring-[#07183D]"
          />
        </div>

        <Button
          type="submit"
          className="w-full bg-[#536878] hover:bg-[#536878]/90 text-white"
        >
          Activate Code Word
        </Button>
      </form>
