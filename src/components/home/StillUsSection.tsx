...
const StillUsSection = () => {
  const cards: CardContent[] = [
    ...
    },
    {
      ...
      tools: ["Talk It Out Prompt Library", "Repair Ritual Suggestions", "Build a Bridge"],
      comingSoonTools: ["Reminder: You haven't sent a Love Note yet today…"],
      link: "/post-conflict",
    ...
    },
    {
      ...
      tools: ["Would You Rather: Couples Game", "Love Code Quiz", "Blueprint Quiz"],
